...
export const Addstockupform = (props) => {
...
streaming stopped successfully!!!        </p>
  ...
  <div className="mb-3">
    <label htmlFor="stockup" className="form-label" >Stock name</label>
    <input type="text" className="form-control" required='required' value={stockup} onChange={(e)=>setstockup(e.target.value)} id="stockname" aria-describedby="emailHelp"/>
  </div>
  <div className="mb-3">
